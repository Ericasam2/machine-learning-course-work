...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        # self.conv1 = nn.Conv2d(1, 10, kernel_size = 5)  # 设置卷积层 Conv2d(int in_channels, int out_channels) 
        # self.conv2 = nn.Conv2d(10, 20, kernel_size = 5)
        # self.conv2_drop = nn.Dropout2d()  # 随机闲置一部分节点
        # self.fc1 = nn.Linear(320, 50)  # 设置线性层
        # self.fc2 = nn.Linear(50, 10)
        self.fc1 = nn.Linear(28*28, 50)  # 设置线性层
        self.fc2 = nn.Linear(50, 10)
    ...
    def forward(self, x):
        ...
        x = x.view(-1, 28*28)  # 将原数组变换成(m,n)的数组
